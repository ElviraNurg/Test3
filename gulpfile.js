...
function buildSvg() {
    return gulp.src('src/assets/img/icons/*.svg', { base: srcPath + "assets/img/icons" }) // svg files for sprite
        .pipe(cheerio({
            run: function ($) {
...
const build = gulp.series(clean, gulp.parallel(html,css, js, images, webpImages, fonts, buildSvg))
